...
export default function Edukasi() {
  return (
    <>
      <Head>
        <title>Dokma Allah Tritunggal dalam Iman Kristen</title>
      </Head>
      <header>
        <div>
          <h1 className="text-xl py-4 md:text-2xl font-semibold mt-5">
            Dokma Allah Tritunggal dalam Iman Kristen
          </h1>
      ...
      <section>
        ...
        <article>
          <h2 className="text-2xl font-semibold mt-5">Allah Tritunggal</h2>
          <p>
            Dogma tentang <strong>Allah Tritunggal</strong> merupakan salah satu
            doktrin utama dalam ajaran Kristen. Dogma ini menyatakan bahwa Allah
            adalah satu esensi yang terdiri dari tiga pribadi: Bapa, Putra
            (Yesus Kristus), dan Roh Kudus.
          </p>
          <p>
            Ketiga pribadi tersebut sepenuhnya adalah Allah dan memiliki esensi
            yang sama. Namun, mereka berbeda dalam fungsi dan peran, seperti
            Bapa sebagai pencipta, Putra sebagai penebus, dan Roh Kudus sebagai
            penghibur serta pemberi kekuatan.
          </p>
          <p>
            Dogma ini menegaskan bahwa Tritunggal bukanlah tiga Tuhan yang
            terpisah, melainkan satu Tuhan yang hadir dalam tiga pribadi. Konsep
            ini menjadi fondasi keimanan Kristen dalam memahami hubungan antara
            Allah, manusia, dan keselamatan.
          </p>
        </article>

        <article>
          <h2 className="text-2xl font-semibold mt-5">
            Asal-usul Dogma Tritunggal
          </h2>
          <p>
