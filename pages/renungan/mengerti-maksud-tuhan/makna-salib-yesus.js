  ...
  return (
    <>
      ...
      <section>
        ...
        <article>
          <h2 className="text-xl font-semibold">Kasih yang Mengalahkan Dosa</h2>
          <p>
          ...
          <p>
            ...
            Salib Yesus membuktikan bahwa kasih mengalahkan dosa, sehingga
            sangat wajar jika Yesus mengharuskan semua orang yang percaya
        ...
        <article>
          <h2 className="text-xl font-semibold">
            Panggilan untuk Mengasihi Sesama
          </h2>
          <p>
            Melalui salib Yesus, Tuhan menunjukan kasih-Nya kepada manusia yang
            penuh dosa. Yesus mengajarkan kita untuk saling mengasihi sesuai
            dengan yang tertulis dalam Yohanes 13:34-35 &quot;Aku memberikan
        ...
        <article>
          <h2 className="text-xl font-semibold">
            Hidup yang Penuh Perjuangan dan Pengharapan
          </h2>
          <p>
          ...
          <p>
            ...
            kita untuk bisa masuk ke dalam Kerajaan Sorga bersama-sama dengan
            Yesus, Ia naik ke Sorga menyiapkan tempat bagi orang-orang yang
            percaya kepadaNya (Yohanes 14:2-3). Tugas kita sekarang hanyalah
            satu, yaitu berusaha hidup serupa dengan Yesus, agar kita menjadi
            murid Yesus yang sejati, bukan sekedar merasa jadi murid Yesus
            (Matius 5:48).
          </p>
          <p>
        ...
        <article>
          <p>
            Dengan mengerti makna Salib Yesus sebagai Pengorbanan yang Membawa
            Keselamatan, Kasih yang Mengalahkan Dosa, Panggilan untuk Mengasihi
            Sesama, dan Hidup yang Penuh Perjuangan dan Pengharapan, membuat
