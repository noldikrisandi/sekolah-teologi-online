...
export default function Renungan() {
  return (
    <>
      <Head>
        <title>
          Memberi karena Kasih Bukan karena Gengsi atau untuk Investasi
        </title>
      </Head>
      <header>
        <div>
      ...
      <section>
        ...
        <article>
          <p>
            Shalom saudara-saudari yang terkasih di dalam Yesus Kristus. <br />
            Kiranya berkat Damai Sejahtera dari Tuhan selalu menyertai kehidupan
        ...
        <article>
          ...
          <p>
            ...
            karena mengasihi Tuhan. Tapi tenang saudara, perkataan saya tentang
            pendeta tadi tidaklah nyata, karena mana mungkin ada pendeta berkata
            demikian.
          </p>
          <blockquote className="italic text-gray-950">
            ...
            <br />
            <span className="block mt-2 text-sm">- 2 Korintus 9:7</span>
          </blockquote>
          <p>
        ...
        <article>
          ...
          <blockquote className="italic text-gray-950">
            ...
            sehingga Ia harus menggantikannya? Sebab segala sesuatu adalah dari
            Dia, dan oleh Dia, dan kepada Dia: Bagi Dialah kemuliaan sampai
            selama-lamanya!&quot;
            <br />
            <span className="block mt-2 text-sm">- Roma 11:35-36</span>
          </blockquote>
          <p>
            Memberi kepada Tuhan itu karena kita sadar bahwa segala sesuatu
            untuk kemuliaan Tuhan. Jangan sampai kita memberi untuk investasi,
            karena uang itu sebuah benda yang berharga di mata manusia, tetapi
            tidak di mata Tuhan.
          </p>
          <p>
            Mungkin kamu bertanya, lantas kenapa Tuhan menyuruh bangsa Israel
            memberikan persepulahan jika memang uang itu tidak berharga di mata
            Tuhan? Kalau ada yang bertanya demikian seperti belum tuntas membaca
            Firman Tuhan.
          </p>
          <p>
            ...
            dijanjikan oleh Tuhan kepada bangsa Israel, sebagai gantinya Tuhan
            menyuruh semua suku lain di bangsa Israel untuk memberikan
            perpuluhan kepada suku Lewi (Bilangan 18:21).
          </p>
          <p>
            Selain diberikan kepada suku Lewi, perpuluhan juga diperuntuhkan
            untuk orang asing, anak yatim, dan janda yang ada di wilayah Israel
            agar mereka bisa makan dengan kenyang. Ketika memberikan perpuluhan
            Tuhan menjajikan berkat kepada bangsa Israel (Ulangan 14:28-29).
          </p>
          <p>
