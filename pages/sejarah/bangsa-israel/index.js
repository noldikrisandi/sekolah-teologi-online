...
export default function Edukasi() {
  const cards = [
    {
      ...
      altText: "",
      title: "Asal Muasal Bangsa Israel",
      ...
      url: "/sejarah/bangsa-israel/asal-muasa-bangsa-israel",
    ...
    },
    {
      ...
      url: "/sejarah/bangsa-israel/dogma-allah-tritunggal",
      labelBtn: "Selengkapnya",
    },
    {
      ...
      url: "/sejarah/bangsa-israel/dogma-inkarnasi-kristen",
      labelBtn: "Selengkapnya",
    },
    {
      ...
      url: "/sejarah/bangsa-israel/dogma-keselamatan-kristen",
      labelBtn: "Selengkapnya",
    },
  ];
  ...
  return (
    <>
      <h1 className="text-2xl font-bold mb-6">Edukasi Sejarah Bangsa Israel</h1>
